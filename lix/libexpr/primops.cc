...
{
    auto e1 = state.forceInt(*args[0], noPos, "while evaluating the first argument passed to builtins.bitShift");
    auto e2 = state.forceInt(*args[1], noPos, "while evaluating the second argument passed to builtins.bitShift");
    auto res = NixInt{0};
